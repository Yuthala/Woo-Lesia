...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_style( 'woolesia-favicon', get_template_directory_uri(  ) . '/assets/img/favicon.ico' );
	...
	wp_enqueue_script( 'woolesia-mainjs',  get_template_directory_uri() . '/assets/js/main.js' );
} );